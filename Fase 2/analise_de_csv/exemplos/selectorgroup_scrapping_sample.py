...
async def main() -> None:
    ...
    [main_agent,scrapper_agent,summarize_agent,fs_agent],
    model_client=model_client,
    ...
    await Console(team.run_stream(task="Faça o scrapping da página https://www.fee.unicamp.br/sobre-a-feec, resuma seu conteúdo (mencione figuras importantes da historia da feec) e salve este resumo no arquivo feec.txt."))
